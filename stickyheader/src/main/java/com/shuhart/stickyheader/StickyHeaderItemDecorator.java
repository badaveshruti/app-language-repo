...
/*        try {
            View imageView = ((RelativeLayout) ((LinearLayout) ((LinearLayout) parent.getChildAt(topChildPosition))
...
/*
    public boolean isViewClicked(float x, float y, int viewId) {
        final View itemView = currentStickyHolder.itemView;
        ...
        return x >= child.getLeft() + translationX &&
...
*/
    ...
    public interface StickyHeaderItemTouchListener {
        void onStickyHeaderItemTouchListener(View v, MotionEvent event);
    }
}
