...
public class WeekInfoView extends View {
    ...
    private String[] mWeekArray = {"MON", "TUE", "WED", "THU", "FRI", "SAT", "SUN"};
    private String[] mWeekFrenchArray = {"LUN.", "MAR.", "MER.", "JEU.", "VEN.", "SAM.", "DIM."};
    private String[] mWeekPortugueseArray = {"SEG.", "TER.", "QUA.", "QUI.", "SEX.", "SÁB.", "DOM."};
    ...
    public WeekInfoView(Context context, CalendarViewDelegate delegate) {
        ...
        if (Locale.getDefault().getLanguage().contains("fr"))
            mWeekArray = mWeekFrenchArray;
        else if (Locale.getDefault().getLanguage().contains("pt"))
            mWeekArray = mWeekPortugueseArray;
