...
class CalendarViewDelegate {
    ...
    private @ColorInt
    int mTopTextColor;        //日历的日期颜色

    private @ColorInt
    int mBottomTextColor;   //节日，阴历的日期颜色

    private @ColorInt
    int mBackgroundColor;    //背景颜色

    private @ColorInt
    int mSelectedItemColor;
    ...
    private @ColorInt
    int mSelectedSchemeColor;

    private @ColorInt
    int mWeekInfoBackgroundColor;

    private @ColorInt
    int mWeekInfoTextColor;

    private int mWeekInfoTextSize;

    private Date mSelectedDate;
    private int startYear, startMonth;
    private boolean mShowEventDot = true; //setting default true

    private HashMap<String, Integer> mMapEventsDates = new HashMap<>();
    ...
    public void setShowLunar(boolean showEventDot) {
        mShowEventDot = showEventDot;
    }

    public boolean isShowEventDot() {
        return mShowLunar;
    }

    public void setShowEventDot(boolean showEventDot) {
        mShowEventDot = showEventDot;
    }

    public HashMap<String, Integer> getMapEventsDates() {
        return mMapEventsDates;
    }

    public void setMapEventsDates(HashMap<String, Integer> mapEventsDates) {
        mMapEventsDates = mapEventsDates;
    }
