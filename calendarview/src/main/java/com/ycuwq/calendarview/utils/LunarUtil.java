...
//            "六月", "七月", "八月", "九月", "十月", "冬月", "腊月"};
    ...
    private static final String[] monthInfo = new String[]{"", "January", "February", "March", "April", "May",
            "June", "July", "August", "September", "October", "November", "December"};

    //    private static final String[] dayInfo = new String[]{"", "一", "二", "三", "四", "五", "六", "七", "八", "九"};
    private static final String[] dayInfo = new String[]{"", "1", "2", "3", "4", "5", "6", "7", "8", "9"};
     ...
     * @param month 公历月
     * @param day   公历日
     * @return 0：农历月 1：农历日 2：农历节日  3：节气
     */
    static String[] getLunarInfo(int year, int month, int day) {
        String[] info = new String[4];
        int[] lunarInts = solarToLunar(year, month, day);
        info[0] = getLunarMonth(lunarInts[1]);
        info[1] = getLunarDay(lunarInts[2]);
        info[2] = getLunarHoliday(lunarInts[0], lunarInts[1], lunarInts[2]);
        //节气比较费资源
        info[3] = getSolarTerm(year, month, day);
        return info;
    }
     ...
     */
/*
    static String getLunarHoliday(int year, int month, int day) {
        String holiday = "";
        if (month == 1 && day == 1) {
            holiday = "春节";
