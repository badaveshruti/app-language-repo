...
//            return;
        ...
        int chipIPheight = mChipsInput.getHeight();
        //Handle for-View not Loading App CRASHES
        if (chipIPheight == 0) {
            ...
            mChipsInput.post(new Runnable() {
                ...
                public void run() {
                    ...
                    int[] coord = new int[2];
                    mChipsInput.getLocationInWindow(coord);
                    int chipIPheight = mChipsInput.getHeight(); //height is ready
                    ViewGroup.MarginLayoutParams layoutParams = (MarginLayoutParams) getLayoutParams();
                    layoutParams.topMargin = coord[1] + chipIPheight;
