...
class NumericLast2ViewHolder(
    ...
    val edtNumeric: CustomEditText = view.findViewById(R.id.edtNumeric)
    val tvLast2Readings: CustomTextView = view.findViewById(R.id.tvLast2Readings)
    val tvPrevPercent1: CustomTextView = view.findViewById(R.id.tvPrevPercent1)
    val tvPrevPercent2: CustomTextView = view.findViewById(R.id.tvPrevPercent2)
    ...
    fun setNumericValue(metaData: MetaData) {
        ...
        scopeMainThread.launch {
            formOperations.handleLast2ReadingAndPercentage(
                metaData,
                this@NumericLast2ViewHolder
            )
        }
    }
...
//                                setDataOnChanged(metaData.metaParamID)
            ...
            edtNumeric.onFocusChangeListener = View.OnFocusChangeListener { _, hasFocus ->
                if (!hasFocus) {
                    try {
